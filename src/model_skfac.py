...
class Model_SKFAC(Model):
    ...
    def __init__(self, network, loss_fn=None, optimizer=None, metrics=None, eval_network=None,
        ...
        super(Model_SKFAC, self).__init__(network, loss_fn, optimizer, metrics, eval_network,
                ...
                if context.get_context("device_target") == "GPU":
                    if switch_branch_one:
                        ...
                        if train_network_init_flag:
                            self._train_network.add_flags_recursive(skfac=True)
                        ...
                        cb_params.cur_step_num += 1
                        if train_network_init_flag:
                            self._train_network.add_flags_recursive(skfac=False)
